...
if (isset($_POST['fname'])) {
    ...
    $sql = "INSERT INTO `agro`.`buynow` (`fname`, `lname`, `inputadress`, `inputcity`, `landmark`, `inputzip`, `current_time`, `Product`)
     VALUES ('$fname', '$lname', '$house', '$landmark', '$city', '$pincode', current_timestamp(), '$product');";
...
<body>
    ...
    <div class="bynow">
        ...
        <div class="delivery-details">
            ...
            <form action="bynow.php" method="post">
                <div class="drop_item">
                    <select name="product" id="product">
                        <option value="matrix">Matrix</option>
                        <option value="INDOFIL">INDOFIL M-45</option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="house" id="inputAddress" placeholder="1234 Main St">
                </div>
                <div class="form-group">
                    <label for="inputAddress2">Landmark,Street Name</label>
                    <input type="text" class="form-control" name="landmark" id="inputAddress2" placeholder="Apartment, studio, or floor">
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="followus topcontact">
                            <center>
                                <ul class="social-network social-circle">
                                    <li><a href="https://www.facebook.com/adhaleshwar.agrotech.1" class="icoFacebook" title="Facebook"><i class="fab fa-facebook"></i></a>
                                    </li>
                                    <li><a href="https://twitter.com/adhaleshwar" class="icoTwitter" title="Twitter"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="#" class="icoLinkedin" title="Linkedin"><i class="fab fa-linkedin"></i></a></li>
                                    <li><a href="https://www.instagram.com/adhaleshwar_agrotech/" class="icoLinstagram" title="Instragram"><i class="fab fa-instagram"></i></a></li>
                                </ul>
                            </center>
