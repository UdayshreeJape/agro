...
if (isset($_POST['fname'])) {
    ...
    $sql = "INSERT INTO `agro`.`fertilizer buy` (`first_name`, `last_name`, `house_no`, `landmark`, `city`, `pin_code`, `cdate_and_time`) VALUES ('$fname', '$lname', '$house', '$landmark', '$city', '$pincode', current_timestamp());";
...
<body>
    ...
    <div class="bynow">
        ...
        <div class="delivery-details">
            ...
            <h3 id="det"> Details</h3>
            <form action="fer_buynow.php" method="post">
                <div class="drop_item">
