        ...
        <div class="regis">
            <div class="regi">
                <form method="post" action="reg.php">
                    ...
                    <button class="submit_">Registration</button>
...
if (isset($_POST['first_name'])) {
    ...
    $sql = "INSERT INTO `agro`.`logandreg` (`first_name`, `last_name`, `email_id`, `password`, `c_password`, `c_date_time`) 
    VALUES ('$full_name', ' $last_name', '$email_id', '$password', '$c_password', current_timestamp());";
